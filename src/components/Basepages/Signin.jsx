  ...
  return (
    <>
      <div className="h-screen  bg-black">
        <div className=" mflex flex-1 flex-col  justify-center items-center px-6 py-12 lg:px-8 ">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full  sm:max-w-sm bg-gray-800 bg-opacity-70 backdrop-blur-xl  rounded-xl   shadow-dark:border-transperant-700 p-8">
          ...
          <p className="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
            <Link to='/signup'>
              <span className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 underline">
